---
eip: <to be assigned>
title: Contract ABI JSON Shorthand Codes
author: Dillon Vincent (@dillonsvincent)
discussions-to: dillonsvincent@gmail.com
status: Draft
...
Construct a contract's ABI JSON at runtime based off a standard interface.
